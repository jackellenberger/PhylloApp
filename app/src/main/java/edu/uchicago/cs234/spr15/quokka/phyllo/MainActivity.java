...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userDb.createStory("tip", "This is tip number 1", "", ts.getTime(), "The Quokka in the Sky", -1.0,-1.0, new String[]{"tweet","tip","brand new","it works"});
        userDb.createStory("longform", "This is longform number 1", getString(R.string.filler_text), ts.getTime(), "The Quokka in the Sky", -1.0,-1.0, new String[]{"Latin filler","readme.txt","blogosphere"});
        userDb.createStory("url", "This is link number 1", "https://cs.uchicago.edu", ts.getTime(), "The Quokka in the Sky", -1.0,-1.0, new String[]{"uchicago","cs","sup","a long tag that will hopefully force a line break","2 many tags 2 handle","help, drowning in tags over here"});
