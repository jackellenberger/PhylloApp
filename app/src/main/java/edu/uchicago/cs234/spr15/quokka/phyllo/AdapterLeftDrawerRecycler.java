...
public class AdapterLeftDrawerRecycler extends RecyclerView.Adapter<AdapterLeftDrawerRecycler.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView,int ViewType) {                 // Creating ViewHolder Constructor with View and viewType As a parameter
            ...
            if(ViewType == TYPE_ITEM) {
                ...
                Name = (TextView) itemView.findViewById(R.id.user_name);         // Creating Text View object from header.xml for name
                email = (TextView) itemView.findViewById(R.id.user_email);       // Creating Text View object from header.xml for email
                profile = (ImageView) itemView.findViewById(R.id.user_icon);    // Creating Image view object from header.xml for profile pic
    ...
    AdapterLeftDrawerRecycler(String Titles[], int Icons[], String Name, String Email, int Profile){ // MyAdapter Constructor with titles and icons parameter
    ...
    @Override
    public AdapterLeftDrawerRecycler.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(AdapterLeftDrawerRecycler.ViewHolder holder, int position) {
